          ...
          <p className="pr-1">
            <div className="flex flex-row items-center">
              <Link to={`/profile/${username}`}>
                <div className="flex flex-row items-center">
                  <img
                    className="h-8 object-contain mask mask-circle"
                    width="32"
                    height="32"
                    src={
                      profile.profile_pic
              ...
              <Link to={`/profile/${username}`}>
                <div className="flex flex-row items-center">
                  <div className="text-link pl-2">{username}</div>
                </div>
              </Link>
              <div>
                &nbsp;added new chapter
                <Link to={`/view/${activity.chapter_ID}`}>
                  <span className="text-comic">
                    &nbsp;{activity.chapter_name}&nbsp;
                  </span>
                </Link>
                to
                <Link to={`/info/${activity.content_ID}`}>
                  <span className="text-comic">
        ...
        <div className="flex flex-row col-span-9">
          <p className="pr-1">
            <div className="flex flex-row items-center">
              ...
              <div>
                &nbsp;replied to post
                <Link to={`/post/${activity.content_ID}`}>
                  <span className="text-forum">
                    &nbsp;{activity.content_name}
                  </span>
                </Link>
              </div>
