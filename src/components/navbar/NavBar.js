...
const NavBar = ({showSidebarCallback,auth,toggleLoginCallback,toggleRegisterCallback,fetchUser,user}) => {
  ...
  return (
    <div className="navbar bg-base-100 drop-shadow mb-5 h-14 min-h-0 relative z-50">
      <div className="navbar-start">
        <label tabIndex="0" className="btn btn-ghost btn-circle h-9 w-9 min-h-0 mr-1" onClick={() => {showSidebarCallback()}}>
          <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 stroke-icon-grey" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h16M4 18h7" /></svg>
        </label>
        <Link to="/">
        ...
        <div className="navbar-end">
          ...
          <div>
            ...
            <div className="dropdown dropdown-end">
              ...
              <ul tabIndex="0" className="dropdown-content menu mt-3 shadow bg-base-100 rounded-box w-52">
                <li>
          ...
          <div>
            ...
            <div className="dropdown dropdown-end">
              ...
              <ul tabIndex="0" className="dropdown-content menu mt-3 shadow bg-base-100 rounded-box w-40">
                <li>
                  <div onClick={() => {toggleLoginCallback(true)}}>
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 stroke-icon-grey stroke-[1.5]" fill="none" viewBox="0 0 24 24">
                ...
                <li>
                  <div onClick={() => {toggleRegisterCallback(true)}}>
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 stroke-icon-grey stroke-[1.5]" fill="none" viewBox="0 0 24 24">
