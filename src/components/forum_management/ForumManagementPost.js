...
const ForumManagementPost = ({cover, title, publicationDate, tags, toggleForumCallback, toggleForumDeleteCallback}) => {
    ...
    <div className="grid grid-cols-5 ">
        ...
        <div className="col-span-4">
          <div className="flex flex-row">
            <div>
              <Link to="/post"><img className="object-fit max-h-48 mb-4 mr-4 rounded" src={cover}/></Link>
            </div>
            <div>
