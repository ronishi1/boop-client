...
const SideBar = ({showSidebar,hideSidebarCallback,auth}) => {
    ...
    <div className="absolute top-0 z-10">
      <Transition show={showSidebar} appear={true}>
            ...
            <div className="h-full z-50 relative">
              <ul class="menu bg-base-100 w-48 rounded-br-md">
                    ...
                    <div class="flex items-center justify-center w-full">
                      <label for="toggleB" class="flex items-center cursor-pointer">
                        <div class="relative">
                          ...
                          <div class="dot-holder block border-2 border-comic w-16 h-8 rounded-full transition duration-500"></div>
                          <div class="dot absolute left-1 top-1 bg-comic w-6 h-6 rounded-full transition duration-500"></div>
                        </div>
                      </label>
                    </div>
                  </a>
                ...
                <div>
                  ...
                  <li>
                    <Link to="/favorites" className="h-12 text-xl text-slate-600" onClick={hideSidebarCallback}>
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 stroke-slate-600 stroke-2" fill="none" viewBox="0 0 24 24">
                  ...
                  <li>
                    <Link to="/read-list" className="h-12 text-xl text-slate-600" onClick={hideSidebarCallback}>
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 stroke-slate-600 stroke-2" fill="none" viewBox="0 0 24 24">
